...
// Exporta o componente estilizado ShipContainer
...
// Exporta o componente estilizado NovoAluno, que estiliza o componente Link do react-route-dom
export const NovoShip = styled(Link)`
  display: block;
