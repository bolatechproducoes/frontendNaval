...
// Exporta o componente estilizado ModelContainer
...
// Exporta o componente estilizado NovoModel, que estiliza o componente Link do react-route-dom
export const NovoModel = styled(Link)`
  display: block;
